  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-2">
        ...
        <li class="breadcrumb-item"><a href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/realisations', ENT_QUOTES, 'UTF-8') ?>">Réalisations</a></li>
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-end gap-3">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a class="btn btn-outline-primary" href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/contact', ENT_QUOTES, 'UTF-8') ?>"><i class="bi bi-chat-square-dots me-2"></i>Contact</a>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            ...
            <div class="row g-3">
              <div class="col-6">
                <div class="p-3 bg-light rounded-4">
                  <div class="text-secondary small">Catégorie</div>
            ...
            <div class="d-flex flex-wrap gap-2 mt-4">
              ...
              <a class="btn btn-outline-secondary" href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/realisations', ENT_QUOTES, 'UTF-8') ?>"><i class="bi bi-arrow-left me-2"></i>Retour galerie</a>
            </div>
          </div>
        </div>
      </div>
