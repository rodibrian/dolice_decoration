...
<section class="card">
  <div class="row between">
    <h1>Témoignages</h1>
    <a class="btn primary" href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/admin/testimonials/create', ENT_QUOTES, 'UTF-8') ?>">Nouveau</a>
  </div>
      ...
      <?php else: ?>
        <?php foreach ($testimonials as $t): ?>
          <tr>
            ...
            <td><?= ((string)$t['status'] === 'approved') ? 'Approuvé' : 'En attente' ?></td>
            <td class="actions">
