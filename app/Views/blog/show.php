  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-2">
        ...
        <li class="breadcrumb-item"><a href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/blog', ENT_QUOTES, 'UTF-8') ?>">Blog</a></li>
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            ...
            <div class="text-secondary mb-3">Décris ton projet, réponse rapide.</div>
            <a class="btn btn-brand w-100" href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/devis', ENT_QUOTES, 'UTF-8') ?>"><i class="bi bi-clipboard-check me-2"></i>Demander un devis</a>
            <a class="btn btn-outline-secondary w-100 mt-2" href="<?= htmlspecialchars((env('APP_URL', '') ?: '') . '/contact', ENT_QUOTES, 'UTF-8') ?>"><i class="bi bi-chat-square-dots me-2"></i>Contact</a>
          </div>
        </div>
      </div>
    </div>
